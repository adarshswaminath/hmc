...
function Hero() {
  ...
  return (
    <div>
      <div
        className="max-w-screen h-screen flex items-center justify-center lg:justify-end p-16"
        style={divStyle}
      >
        <div className="justify-end">
          <h1 className="font-semibold text-7xl lg:text-9xl font-mono text-white">
            YACHTS
          </h1>
